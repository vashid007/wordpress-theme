        ...
        <div class="hero-grid">
            <div class="hero-content">
                ...
                <p class="hero-description">
                    Full-Stack Web Developer with a strong focus on custom WordPress engineering, clean PHP architecture, and modern, high-performance web applications.
                </p>
        ...
        <div class="bio-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: start;">
            ...
            <div class="bio-card skill-card" style="padding: 2.5rem;">
                ...
                <p style="color: #94a3b8; font-size: 1rem; line-height: 1.8; margin-bottom: 1.25rem;">
                    Hello! I'm <strong>Abdul Vashid</strong>, a passionate Web Developer dedicated to transforming ideas into fast, elegant, and secure digital products.
                </p>
                <p style="color: #94a3b8; font-size: 1rem; line-height: 1.8; margin-bottom: 1.25rem;">
                    Over the years, I have specialized in custom WordPress theme and plugin development, craft-tailored backend PHP code, and modern JavaScript frontend interfaces. I believe that code should not only function flawlessly but should also be easy to maintain and scale.
                </p>
                <p style="color: #94a3b8; font-size: 1rem; line-height: 1.8;">
                    Whether it's building a complex web application from scratch or setting up automated Git deployment pipelines to live hosting servers, I focus on delivering seamless developer and user experiences.
                </p>
            </div>
            ...
            <div class="skills-overview-card skill-card" style="padding: 2.5rem;">
                ...
                <div class="skill-progress-item" style="margin-bottom: 1.5rem;">
                    <div style="display: flex; justify-content: space-between; color: #f8fafc; font-weight: 500; font-size: 0.95rem; margin-bottom: 0.5rem;">
                    ...
                    <div style="background: rgba(255, 255, 255, 0.1); height: 8px; border-radius: 9999px; overflow: hidden;">
                        <div style="width: 95%; height: 100%; background: linear-gradient(90deg, #6366f1, #38bdf8); border-radius: 9999px;"></div>
                    </div>
                </div>
                ...
                <div class="skill-progress-item" style="margin-bottom: 1.5rem;">
                    ...
                    <div style="background: rgba(255, 255, 255, 0.1); height: 8px; border-radius: 9999px; overflow: hidden;">
                        <div style="width: 90%; height: 100%; background: linear-gradient(90deg, #6366f1, #38bdf8); border-radius: 9999px;"></div>
                    </div>
                </div>
                ...
                <div class="skill-progress-item">
                    ...
                    <div style="background: rgba(255, 255, 255, 0.1); height: 8px; border-radius: 9999px; overflow: hidden;">
                        <div style="width: 88%; height: 100%; background: linear-gradient(90deg, #6366f1, #38bdf8); border-radius: 9999px;"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="skills-grid">
            <div class="skill-card">
                ...
                <p>Clean code architecture ensuring fast page loads, optimized database queries, and lightweight assets.</p>
            </div>
            ...
            <div class="skill-card">
                ...
                <p>Attentive to UI/UX details, smooth micro-interactions, dark glassmorphism, and responsive layouts.</p>
            </div>
    ...
    <section style="padding: 3rem 0; background: #0f172a; color: #ffffff;">
        <div class="container">
            ...
            while ( have_posts() ) :
                ...
                if ( get_the_content() ) :
                    ?>
                    <article class="post-card" style="background: var(--bg-card); color: #94a3b8; border-color: var(--border-glass);">
